...
public class PolicyScript : MonoBehaviour
{
    public Policy[] policies = new Policy[]
    {
        new Policy(1, "RobbinFood",
            ...
            "PolicySource1",1,-2,0,0,0,0,2,0,-3,0,0,0,-2
        ),
        new Policy(2, "PetroBigBro",
           ...
           "PolicySource2", 3,6,0,0,-1,0,3,0,0,0,0,-0.1f,1
        ),
        new Policy(3,"RedGreenBurn",
           ...
           "PolicySource1", 3,-6,0,0,4,0,2,0,0,0,10,0,-4
        ),
        new Policy(4,"PlantGrant",
           ...
           "PolicySource3", 3, 0,0,0,0,0,0,0,0,0,-2,0.1f,-2
        ),
        new Policy(5,"TreeToFood",
           ...
           "PolicySource3", 1,6,0,0,3,0.4f,-4,-3,-5,0,0,-0.4f,4
        ),
        ...
        new Policy(7,"FoodForPower",
           ...
           "PolicySource2", 1,0,3, -5,0,0,2,0,-4,0,0,0,-3
        ),
    };
