...
public class PolicyScript : MonoBehaviour
{
    public Policy[] policies = new Policy[]
    {
        new Policy(1, "RobbinFood",
            ...
            "PolicySource5",1,-1,2,0,0,0.1f,2,0,-3,0,0,0,-2
        ),
        new Policy(2, "PetroBigBro",
           ...
           "PolicySource1", 3,8,0,0,-1,0,3,0,0,0,0,0.1f,1
        ),
        new Policy(3,"RedGreenBurn",
           ...
           "PolicySource2", 3,0,0,0,1,0.1f,10,10,0,0,5,0,-20
        ),
        new Policy(4,"PlantGrant",
           ...
           "PolicySource5", 2, 0,0,0,0,0,0,0,0,0,-2,0.1f,-2
        ),
        new Policy(5,"TreeToFood",
           ...
           "PolicySource1", 1,7,4,0,3,0.6f,-4,-2,-4,0,0,-0.4f,12
        ),
